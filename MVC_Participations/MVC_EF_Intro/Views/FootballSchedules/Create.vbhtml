...
@Using (Html.BeginForm()) 
    ...
    @<div class="form-horizontal">
        ...
        <div class="form-group">
            @Html.LabelFor(Function(model) model.Opponent, htmlAttributes:= New With { .class = "control-label col-md-2" })
            <div class="col-md-10">
                @Html.EditorFor(Function(model) model.Opponent, New With { .htmlAttributes = New With { .class = "form-control" } })
                @Html.ValidationMessageFor(Function(model) model.Opponent, "", New With { .class = "text-danger" })
            </div>
        </div>
        ...
        <div class="form-group">
            @Html.LabelFor(Function(model) model.IsHomeGame, htmlAttributes:= New With { .class = "control-label col-md-2" })
            <div class="col-md-10">
                <div class="checkbox">
                    @Html.EditorFor(Function(model) model.IsHomeGame)
                    @Html.ValidationMessageFor(Function(model) model.IsHomeGame, "", New With { .class = "text-danger" })
                </div>
            </div>
        </div>
